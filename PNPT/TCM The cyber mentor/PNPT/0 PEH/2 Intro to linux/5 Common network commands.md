...
- `ifconfig`
	- Only shows eth0
-  `iwconfig`
	- shows wireless connection
- `ip n`
	- `ip n` stands for neighbour 
	- its alternative is 
		- `arp -a`
- `ip r`
	- For looking at routing table
	- theres also an alternative by using the route command
		- `route`
- `ping`
	- Not all machines have ICMP traffic enabled
