...
chmod +w // gives W
chmod +r // gives R
chmod +rwx // gives all RWX
```
or

```
chmod 777 hello.txt // gives ALL
```


![[4 Users and privilege-20240114141530214.webp]]



We can also add users using the following
...
we can use this to check what the user can run as user
