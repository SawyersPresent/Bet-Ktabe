...
```shell-session
Hillside_1@htb[/htb]$ mssqlclient.py sql_dev@10.129.43.30 -windows-auth
...
```shell-session
Hillside_1@htb[/htb]$ sudo nc -lnvp 8443
...
https://hideandsec.sh/books/windows-sNL/page/in-the-potato-family-i-want-them-all#bkmrk-how-it-works-13