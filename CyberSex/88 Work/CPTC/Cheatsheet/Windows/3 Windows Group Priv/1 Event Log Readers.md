...
```
PS C:\Users\logger> wevtutil qe Security /rd:true /f:text | Select-String "/u"

        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource core
        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource scheduler
        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource core
        Process Command Line:   SharpChrome.exe  logins /unprotect
        Process Command Line:   cmdkey  /add:WEB01 /user:amanda /pass:Passw0rd!
        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource scheduler
        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource core
        Process Command Line:   "C:\Program Files (x86)\Google\Update\GoogleUpdate.exe" /ua /installsource scheduler
        Process Command Line:   "C:\Program Files (x86)\Google\Temp\GUM42D0.tmp\GoogleUpdate.exe" /update /sessionid
```
