...
```
kali@kali ~> nmap -sC -sV -Pn 10.10.10.245
Starting Nmap 7.94SVN ( https://nmap.org ) at 2024-09-29 06:34 EDT
Stats: 0:01:41 elapsed; 0 hosts completed (1 up), 1 undergoing Service Scan
Service scan Timing: About 66.67% done; ETC: 06:37 (0:00:50 remaining)
...
|     Server: gunicorn
|     Date: Sun, 29 Sep 2024 10:35:14 GMT
|     Connection: close
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Sun, 29 Sep 2024 10:35:07 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
|     HTTP/1.0 200 OK
|     Server: gunicorn
|     Date: Sun, 29 Sep 2024 10:35:08 GMT
|     Connection: close
|     Content-Type: text/html; charset=utf-8
...
SF-Port80-TCP:V=7.94SVN%I=7%D=9/29%Time=66F92D5B%P=x86_64-pc-linux-gnu%r(G
SF:etRequest,4C56,"HTTP/1\.0\x20200\x20OK\r\nServer:\x20gunicorn\r\nDate:\
SF:x20Sun,\x2029\x20Sep\x202024\x2010:35:07\x20GMT\r\nConnection:\x20close
...
SF:\x2029\x20Sep\x202024\x2010:35:08\x20GMT\r\nConnection:\x20close\r\nCon
...
SF:20Sun,\x2029\x20Sep\x202024\x2010:35:14\x20GMT\r\nConnection:\x20close\
SF:r\nContent-Type:\x20text/html;\x20charset=utf-8\r\nContent-Length:\x202
...
Nmap done: 1 IP address (1 host up) scanned in 152.29 seconds
