...
- [Malleable C2 Profiles](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#malleable-c2-profiles)
- [Reflective Shellcode Loaders](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#reflective-shellcode-loaders)
- [Domain Enumeration](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#domain-enumeration)
- [Local Privilege Escalation](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#local-privilege-escalation)
- [Lateral Movement](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#lateral-movement)
- [Domain Privilege Escalation](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#domain-privilege-escalation)
- [Defense Evasion](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#defense-evasion)
- [Exploitation](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#exploitation)
- [Exfiltration - Password Attacks](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#exfiltration---password-attacks)
- [Exfiltration - Email](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#exfiltration---email)
- [Persistence](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#persistence)
- [Cobalt Strike BOFs](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#cobalt-strike-bofs)
- [References](https://github.com/wsummerhill/CobaltStrike_RedTeam_CheatSheet#references)
...
[SharpShares](https://github.com/mitchmoser/SharpShares) - List accessible shares on remote systems and check read/write privileges  
 
...
- Using [CIMplant](https://github.com/FortyNorthSecurity/CIMplant)  
     
...
### [WinPEAS](https://github.com/carlospolop/PEASS-ng/tree/master/winPEAS/winPEASexe) - Windows Privilege Escalation Awesome Script  
 
...
[RACE.ps1](https://github.com/samratashok/RACE): ACL attacks for lateral movement, persistence and privilege escalation Stealthier than above method since it doesn't touch disk
...
[Move Kit](https://github.com/0xthirteen/MoveKit) Aggressor script using execute-assembly, SharpMove and SharpRPD assemblies for doing lateral movement with various techniques
...
[SharpLaps](https://github.com/swisskyrepo/SharpLAPS) - Retrive LAPS password from AD  
The attribute ms-mcs-AdmPwd stores the clear-text LAPS password which is targeted here from LDAP  
...
- https://hakin9.org/domain-takeover-with-petitpotam-exploit/
...
[BOF-patchit](https://github.com/ScriptIdiot/BOF-patchit) for current process  
`patchit amsi`

[boku7/InjectAmsiBypass](https://github.com/boku7/injectAmsiBypass) BOF  
Patch AMSI in remote process `inject-amsiBypass <PID>`
...
[ajpc500/BOFs](https://github.com/ajpc500/BOFs/) ETW patch for current process  
`etw stop` / `etw start`
