...
```python
PS C:\tools> Get-DomainComputer | select dnshostname, useraccountcontrol, objectsid

dnshostname                                                        useraccountcontrol objectsid
-----------                                                        ------------------ ---------
DC01.INLANEFREIGHT.LOCAL                 SERVER_TRUST_ACCOUNT, TRUSTED_FOR_DELEGATION S-1-5-21-2974783224-3764228556-2640795941-1000
EXCHG01.INLANEFREIGHT.LOCAL                                 WORKSTATION_TRUST_ACCOUNT S-1-5-21-2974783224-3764228556-2640795941-1103
SQL01.INLANEFREIGHT.LOCAL   WORKSTATION_TRUST_ACCOUNT, TRUSTED_TO_AUTH_FOR_DELEGATION S-1-5-21-2974783224-3764228556-2640795941-1104
WS01.INLANEFREIGHT.LOCAL                                    WORKSTATION_TRUST_ACCOUNT S-1-5-21-2974783224-3764228556-2640795941-1105
DC02.INLANEFREIGHT.LOCAL                    ACCOUNTDISABLE, WORKSTATION_TRUST_ACCOUNT S-1-5-21-2974783224-3764228556-2640795941-1107
```


what does the SPN do here?

```python
PS C:\tools> Get-DomainComputer | select dnshostname, useraccountcontrol, objectsid, msds-allowedtodelegateto, serviceprincipalname


dnshostname              : DC01.INLANEFREIGHT.LOCAL
useraccountcontrol       : SERVER_TRUST_ACCOUNT, TRUSTED_FOR_DELEGATION
objectsid                : S-1-5-21-2974783224-3764228556-2640795941-1000
msds-allowedtodelegateto :
serviceprincipalname     : {exchangeAB/DC01, exchangeAB/DC01.INLANEFREIGHT.LOCAL, TERMSRV/DC01, TERMSRV/DC01.INLANEFREIGHT.LOCAL...}

dnshostname              : EXCHG01.INLANEFREIGHT.LOCAL
useraccountcontrol       : WORKSTATION_TRUST_ACCOUNT
objectsid                : S-1-5-21-2974783224-3764228556-2640795941-1103
msds-allowedtodelegateto : {ldap/DC01.INLANEFREIGHT.LOCAL/INLANEFREIGHT.LOCAL, ldap/DC01.INLANEFREIGHT.LOCAL, ldap/DC01, ldap/DC01.INLANEFREIGHT.LOCAL/INLANEFREIGHT...}
serviceprincipalname     : {tapinego/EXCHG01, tapinego/EXCHG01.INLANEFREIGHT.LOCAL, TERMSRV/EXCHG01, TERMSRV/EXCHG01.INLANEFREIGHT.LOCAL...}

dnshostname              : SQL01.INLANEFREIGHT.LOCAL
useraccountcontrol       : WORKSTATION_TRUST_ACCOUNT, TRUSTED_TO_AUTH_FOR_DELEGATION
objectsid                : S-1-5-21-2974783224-3764228556-2640795941-1104
msds-allowedtodelegateto : {www/WS01.INLANEFREIGHT.LOCAL, www/WS01}
serviceprincipalname     : {tapinego/SQL01, tapinego/SQL01.INLANEFREIGHT.LOCAL, MSSQLSvc/SQL01.INLANEFREIGHT.LOCAL, WSMAN/SQL01...}

dnshostname              : WS01.INLANEFREIGHT.LOCAL
useraccountcontrol       : WORKSTATION_TRUST_ACCOUNT
objectsid                : S-1-5-21-2974783224-3764228556-2640795941-1105
msds-allowedtodelegateto :
serviceprincipalname     : {tapinego/WS01, tapinego/WS01.INLANEFREIGHT.LOCAL, TERMSRV/WS01, TERMSRV/WS01.INLANEFREIGHT.LOCAL...}

dnshostname              : DC02.INLANEFREIGHT.LOCAL
useraccountcontrol       : ACCOUNTDISABLE, WORKSTATION_TRUST_ACCOUNT
objectsid                : S-1-5-21-2974783224-3764228556-2640795941-1107
msds-allowedtodelegateto :
serviceprincipalname     : {Dfsr-12F9A27C-BF97-4787-9364-D31B6C55EB04/DC02.INLANEFREIGHT.LOCAL, RestrictedKrbHost/DC02, HOST/DC02, RestrictedKrbHost/DC02.INLANEFREIGHT.LOCAL...}
```
