...
```powershell
// Using *
kali@kali ~> find . -type f -name "GodPotato-NET*.exe"
./GodPotato-NET4.exe
./GodPotato-NET2.exe
...
kali@kali ~> find . -type f -name "GodPotato-NET[1234].exe"
./GodPotato-NET4.exe
./GodPotato-NET2.exe
...
 [Previous](https://academy.hackthebox.com/module/51/section/472)
