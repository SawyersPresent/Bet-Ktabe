...
![Terminal showing command not found errors for 'wasdf' and 'meep' on a Parrot OS system.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/green-square.png)
...
![Terminal showing PowerShell version 7.1.3 on Linux, with a prompt for a new stable release v7.2.0.](https://cdn.services-k8s.prod.aws.htb.systems/content/modules/115/blue-box.png)
