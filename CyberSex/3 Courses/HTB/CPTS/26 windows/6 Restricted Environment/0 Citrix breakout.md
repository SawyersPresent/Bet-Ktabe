...
```powershell
// --------------------- cheatsheet --------------------- //
\\10.10.10.10\share <----- put this in the file name field

// right clicking the executable and pressing open usually works fine

//for example we could have the binary pwn.exe present, these are its contents.
